...
محصولات، مشخصات و قیمت‌های این نسخه نمونه‌اند و در `lib/storefront.ts` نگه‌داری می‌شوند. سبد با کلید نسخه‌دار `acoffee:preview-cart:v1` در localStorage ذخیره می‌شود؛ ورودی خراب، محصول ناشناخته و تعداد نامعتبر پذیرفته نمی‌شوند. اطلاعات سبد بین تب‌ها همگام می‌شود. هنوز سفارشی ثبت نمی‌شود؛ اتصال دیتابیس اکنون برای احراز هویت و حساب کاربری استفاده می‌شود. در مرحلهٔ تجارت واقعی، محاسبات قیمت و موجودی باید از دادهٔ معتبر سرور انجام شوند.

ورود و ثبت‌نام و حساب واقعی روی Neon پیاده شده‌اند؛ جزئیات در [راهنمای احراز هویت](authentication.md) آمده است. اتصال سبد به حساب، انتخاب آسیاب، پرداخت و ثبت سفارش هنوز پیاده نشده‌اند. متن و تصاویر، پیش‌طرح برند هستند و باید بعد از دریافت لوگو و مشخصات واقعی محصولات نهایی شوند.
